...
namespace PhoneApp1
{
    public partial class App : Application
    {
        ...
        {
            savepass();                                                                  // calling savepass method
            PhoneApplicationService.Current.State["hasspass"] = Settings.HashedPassword; // saving hased password to State
            PhoneApplicationService.Current.State["passhint"] = Settings.PasswordHint;   // saving passwordhint to State
            PhoneApplicationService.Current.State["saltval"] = Settings.Salt;            // saving salt to State
            PhoneApplicationService.Current.State["pass"] = Settings.Password;           // saving password to State
            PhoneApplicationService.Current.State["notestate"] = Settings.NotesList; // Saving Notes to State
        }
        ...
        {
            Settings.settings["hashpass"] = Settings.HashedPassword;                // saving hassed password to IsolatedStorage
            Settings.settings["passhint"] = Settings.PasswordHint;                  // saving password hint to IsolatedStorage
            Settings.settings["saltval"] = Settings.Salt;                            // saving salt  to IsolatedStorage
            Settings.settings["notelistiso"] = Settings.NotesList;                  // Saving Notes to Isolated storage
            Settings.settings.Save();                                               // Saving
